...
async function setDefaultConfiguration() {
  ...
  try {
    ...
    const defaults = {
      ...
      // Add synchronized video filtering options
      filterSynchronizedVideos: false, // Default: don't filter
      synchronizedVideoAction: 'hide', // Options: "nothing", "hide", "notInterested"
    };
